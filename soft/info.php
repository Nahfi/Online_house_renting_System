      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarMenu">
          <ul class="navbar-nav font-weight-bold">
            <li class="nav-item active">
                <a href="admin-page" class="nav-link active">Home</a>
            </li>
            <li class="nav-item">
            </li>
            <li class="nav-item">
...
{
$id=$_GET['details'];
  $query= "SELECT * FROM(SELECT home.floor, home.lift, home.name ,home.id,home.img,room.bed,room.kit,room.washroom,adress.zip,adress.road,adress.house ,book.val  from home join room join adress join book WHERE home.id=room.id AND home.id=adress.id AND home.id=book.id ) as z WHERE z.id=$id  ";
        ...
        <div class="row justify-content-center text-center mb-5">
            <div class="col-lg-4">
              <div class="card">
                  ...
                  <div class="card-body">
                      <h4 class="card-title display-3"><?php echo $namex ?>  (<?php echo $book ?>)</h4>
                      ...
                      <div class="list-card-heading">
                        <ul class="list-card-details">
                          ...
                          <li>
                            <?php echo $road ?>
                            <abbr class="list-card-level">road no</abbr>
                          </li>
