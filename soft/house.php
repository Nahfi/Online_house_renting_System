...
";  
      ...
      if($c==0)
      {
        ...
        echo "YOU ARE BLOCKED FOR 2 DAYS PLEASE WAIT";




        $sql = mysqli_query($con, "SELECT * FROM block WHERE id=$user_id AND verified=0 ");
...
$sql = "UPDATE users SET verified = 1 WHERE id = $user_id;";
      $con->query($sql);
$sql = "UPDATE block SET verified = 1 WHERE id = $user_id;";
      $con->query($sql);
  ...
  else if($_SESSION['customer_sid']==session_id() && $c==1)
  {
